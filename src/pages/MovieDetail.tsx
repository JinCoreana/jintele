          ...
          <>
            <TopInfo>
              <PosterContainer>
                <Backdrop>
                  <LeftBlur />
                  <BackDropImage imageUrl={`https://image.tmdb.org/t/p/original/${data?.backdrop_path}`}>
                    <LeftGradient />
                    <RightGradient />
              ...
              <Main>
                <Container>
                  ...
                  <ContentWrapper>
                    ...
                    <AverageRate>Average ★ {data?.vote_average} ({data?.vote_count} people)</AverageRate>
                    <Action>
                      <StarRate>
                        <StarRateText>Rate</StarRateText>
                        <RatingWrapper>
                          <Rating size="large" />
                        </RatingWrapper>
                      </StarRate>
